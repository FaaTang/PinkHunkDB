...
describe("i18n catalog", () => {
  ...
  it("includes App shortcut modal keys required by every supported language", () => {
    const shortcutModalKeys = [
      ...
      "app.shortcuts.action.sidebarViewTableDdl.label",
      "app.shortcuts.action.openShortcutManager.description",
      "app.shortcuts.action.openShortcutManager.label",
      "app.shortcuts.action.openSettings.description",
      "app.shortcuts.action.openSettings.label",
      ...
      "app.shortcuts.title",
      "app.settings.entry.shortcuts.description",
      "app.settings.entry.shortcuts.title",
      "common.cancel",
      "common.close",
    ] as const;
